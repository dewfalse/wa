...
public class GuiBrewingBarrelII extends GuiContainer {

	private TileEntityBrewingBarrelII tile;
	private TileEntityBrewingBarrelII inventory;

	public GuiBrewingBarrelII(EntityPlayer player, TileEntityBrewingBarrelII par2TileEntity) {
		super(new ContainerBrewingBarrelII(player, par2TileEntity));
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int x, int y) {
		...
		this.mc.getTextureManager().bindTexture(new ResourceLocation("wa", "textures/brewingbarrel2_gui.png"));
