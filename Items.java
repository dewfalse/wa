...
public class Items {
	...
	public static Item 茶碗 = new Item(Config.茶碗ID).setUnlocalizedName("wa:teaEmpty").setCreativeTab(Wa.creativeTab);
	public static Item お茶 = new ItemTea(Config.お茶ID).setUnlocalizedName("wa:tea").setCreativeTab(Wa.creativeTab);
